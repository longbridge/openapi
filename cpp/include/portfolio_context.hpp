...
struct ProfitSummaryInfo { std::string asset_type; std::string profit_max; std::string profit_max_name; std::string loss_max; std::string loss_max_name; };
...
struct ProfitAnalysisItem {
  ...
  int64_t clearance_times; std::string item_type; std::string currency; std::string symbol;
...
struct FlowItem {
  std::string executed_date; std::string executed_timestamp; std::string code; std::string direction;
