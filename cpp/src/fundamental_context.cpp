...
void FundamentalContext::financial_report(const std::string& symbol, int32_t kind, int32_t period, AsyncCallback<FundamentalContext, FinancialReports> callback) const {
  lb_fundamental_context_financial_report(ctx_, symbol.c_str(), kind, period,
    [](auto res) {
