...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct BusinessSegmentItem {
    pub name: String,
    pub percent: String,
}
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct BusinessSegments {
    pub date: String,
    pub total: String,
    pub currency: String,
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct BusinessSegmentHistoryItem {
    pub name: String,
    pub percent: String,
    pub value: String,
}
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct BusinessSegmentsHistoricalItem {
    pub date: String,
    pub total: String,
    pub currency: String,
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct BusinessSegmentsHistory {
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct InstitutionRatingViewItem {
    pub date: String,
    pub buy: String,
    pub over: String,
    pub hold: String,
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct InstitutionRatingViews {
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct IndustryRankItem {
    pub name: String,
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct IndustryRankGroup {
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct IndustryRankResponse {
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct IndustryPeersTop {
    pub name: String,
    pub market: String,
}
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct IndustryPeerNode {
    pub name: String,
    pub counter_id: String,
    pub stock_num: i32,
    pub chg: String,
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct IndustryPeersResponse {
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct SnapshotForecastMetric {
    pub value: String,
    pub yoy: String,
    pub cmp_desc: String,
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct SnapshotReportedMetric {
    pub value: String,
    pub yoy: String,
}
...
#[pyclass(get_all, skip_from_py_object)]
#[derive(Debug, Clone)]
pub(crate) struct FinancialReportSnapshot {
    pub name: String,
    pub ticker: String,
    pub fp_start: String,
    pub fp_end: String,
