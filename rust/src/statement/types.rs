...
pub struct GetStatementDataListResponse {
    pub list: Vec<StatementDataInfo>,
}

/// Statement data info
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct StatementDataInfo {
    pub dt: i32,
    pub file_key: String,
}
...
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct GetStatementDataDownloadUrlResponse {
    pub url: String,
}
...
mod tests {
    use super::{
        CommonStatementContent, GetStatementDataDownloadUrlResponse, GetStatementDataListResponse,
    };
    ...
    fn deserialize_statement_data_list_response() {
        ...
        let response: GetStatementDataListResponse = serde_json::from_str(data).unwrap();
    ...
    fn deserialize_statement_data_download_url_response() {
        ...
        let response: GetStatementDataDownloadUrlResponse = serde_json::from_str(data).unwrap();
