...
pub struct CapitalFlowIntradayResponse {
    ...
    pub symbol: ::prost::alloc::string::String,
    #[prost(message, repeated, tag = "2")]
    pub capital_flow_lines:
        ::prost::alloc::vec::Vec<capital_flow_intraday_response::CapitalFlowLine>,
}
...
impl Command {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "QueryOptionChainDateStrikeInfo" => Some(Self::QueryOptionChainDateStrikeInfo),
...
impl CalcIndex {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "CALCINDEX_FIVE_MINUTES_CHANGE_RATE" => Some(Self::CalcindexFiveMinutesChangeRate),
