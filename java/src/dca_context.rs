...
use longbridge::{Config, DCAContext, dca::types::*};
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_newDcaContext(
    mut env: JNIEnv,
    _class: JClass,
    config: i64,
) -> i64 {
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_freeDcaContext(
    _env: JNIEnv,
    _class: JClass,
    ctx: i64,
) {
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextList(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    opts: JObject,
    ...
    jni_result(&mut env, (), |env| {
        ...
        let status_v: Option<JavaInteger> = if opts.is_null() {
            None
        } else {
            get_field(env, &opts, "status")?
        };
        let status = status_v.map(i32::from).and_then(|v| match v {
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextStats(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    symbol: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextCheckSupport(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    symbols: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextHistory(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    opts: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextPause(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    plan_id: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextResume(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    plan_id: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextStop(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    plan_id: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextCalcDate(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    opts: JObject,
    ...
    jni_result(&mut env, (), |env| {
        ...
        let frequency_v: JavaInteger = get_field(env, &opts, "frequency")?;
        let frequency = match i32::from(frequency_v) {
            0 => DCAFrequency::Daily,
            1 => DCAFrequency::Weekly,
            2 => DCAFrequency::Fortnightly,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextSetReminder(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    hours: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextCreate(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    opts: JObject,
    ...
    jni_result(&mut env, (), |env| {
        ...
        let freq_v: Option<JavaInteger> = get_field(env, &opts, "frequency")?;
        let frequency = freq_v
            .map(i32::from)
            .and_then(|v| match v {
            ...
            .unwrap_or(DCAFrequency::Monthly);
        let day_of_week: Option<String> = get_field(env, &opts, "dayOfWeek")?;
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longbridge_SdkNative_dcaContextUpdate(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    opts: JObject,
    ...
    jni_result(&mut env, (), |env| {
        ...
        let freq_v: Option<JavaInteger> = get_field(env, &opts, "frequency")?;
        let frequency = freq_v.map(i32::from).and_then(|v| match v {
            0 => Some(DCAFrequency::Daily),
            1 => Some(DCAFrequency::Weekly),
            2 => Some(DCAFrequency::Fortnightly),
            3 => Some(DCAFrequency::Monthly),
