...
impl From<GetGridTriggerHistoryOptions> for longbridge::trade::GetGridTriggerHistoryOptions {
    #[inline]
    fn from(opts: GetGridTriggerHistoryOptions) -> Self {
        let mut opts2 = longbridge::trade::GetGridTriggerHistoryOptions::new(opts.grid_order_id);
