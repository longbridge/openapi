...
impl From<GetGridOrderDetailOptions> for longbridge::trade::GetGridOrderDetailOptions {
    #[inline]
    fn from(opts: GetGridOrderDetailOptions) -> Self {
        let mut opts2 = longbridge::trade::GetGridOrderDetailOptions::new(opts.order_id);
