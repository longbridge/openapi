...
impl<'env> From<GridTradeRule<'env>> for longbridge::trade::GridTradeRule {
    fn from(r: GridTradeRule<'env>) -> Self {
        longbridge::trade::GridTradeRule {
...
impl<'env> From<SubmitGridOrderOptions<'env>> for longbridge::trade::SubmitGridOrderOptions {
    #[inline]
    fn from(opts: SubmitGridOrderOptions<'env>) -> Self {
        longbridge::trade::SubmitGridOrderOptions::new(
            opts.symbol,
