...
#[napi_derive::napi]
#[derive(JsEnum, Debug, Hash, Eq, PartialEq)]
#[js(remote = "longbridge::quote::PinnedMode")]
pub enum PinnedMode {
...
#[napi_derive::napi]
#[derive(JsEnum, Debug, Hash, Eq, PartialEq, Copy, Clone)]
#[js(remote = "longbridge::quote::ElementType")]
...
impl From<longbridge::quote::HoldingDetail> for HoldingDetail {
    fn from(v: longbridge::quote::HoldingDetail) -> Self {
        Self {
...
impl From<longbridge::quote::AssetAllocationItem> for AssetAllocationItem {
    fn from(v: longbridge::quote::AssetAllocationItem) -> Self {
        Self {
            name: v.name,
            code: v.code,
...
impl From<longbridge::quote::AssetAllocationGroup> for AssetAllocationGroup {
    fn from(v: longbridge::quote::AssetAllocationGroup) -> Self {
        Self {
...
impl From<longbridge::quote::AssetAllocationResponse> for AssetAllocationResponse {
    fn from(v: longbridge::quote::AssetAllocationResponse) -> Self {
        Self {
